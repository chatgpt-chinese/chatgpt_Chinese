# ChatGPT官网中文版 - ChatGPT中文网，无需翻墙（支持GPT-4，无限使用GPT-4o和o1）【2024/12/15】

> 更新：2024/12/15 <br />
> 作者：chatgpt-chinese 

直接可使用的 **ChatGPT中文版**！**无需翻墙，支持GPT-4，无限使用GPT-4o和o1-preview** 
...
由于众所周知的原因，很多用户无法直接使用 ChatGPT官方，而这些**ChatGPT中文版**让用户**无需翻墙**即可使用上 ChatGPT。

- **无需翻墙**：国内就能直接用，不需要任何代理工具。
- **中文版优化**：ChatGPT镜像站能提供中文界面，更好的中文语言支持。
- **无限制使用4o和o1**：ChatGPT中文版，不受官网GPT-4o（每3小时80次）、o1频次（每周50次）的使用限制，**无限使用GPT-4o和o1**。
...
## 联系我们与持续更新
本项目会不定期更新，好用的镜像站点和使用教程！如有需要，可与我联系~

## 支持我们
如果您觉得本项目有帮助，请点亮 ⭐ Star！让更多人看到~
